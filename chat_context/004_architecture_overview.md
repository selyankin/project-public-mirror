# Flaffy — Architecture Overview (DDD / Modular Monolith)

## 1. Назначение документа

Этот документ описывает **целевую архитектуру Flaffy на уровне модулей и слоёв**, принципы взаимодействия компонентов и основные потоки данных.
...
Flaffy строится как **модульный монолит**:
