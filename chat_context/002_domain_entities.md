# Mirano — Domain Entities & Relationships

## 1. Назначение документа

Этот файл описывает **предметную область Mirano**: ключевые сущности, их смысл, границы ответственности и связи между ними.
...
При описании сущностей Mirano придерживается следующих принципов:
...
Результат аналитической работы Mirano по конкретному объекту или субъекту.
