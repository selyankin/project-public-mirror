# Flaffy — Background Jobs & Results Reuse

## 1. Назначение документа

Этот документ описывает **фоновую модель работы Flaffy**: задачи (jobs), воркеры, переиспользование результатов и правила актуализации данных.
...
Фоновая обработка — **ключевая часть архитектуры Flaffy**, а не оптимизация «на потом».

---

## 2. Общие принципы фоновой обработки

Flaffy строит фоновые процессы вокруг следующих принципов:
...
Flaffy поддерживает плановые фоновые проверки:
